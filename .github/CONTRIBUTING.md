...
If you are still having difficulty after looking over your configuration carefully, please post a question to [StackOverflow with the web-spaceship-game tag](http://stackoverflow.com/tags/web-spaceship-game). This way you help others to help you.
...
Write here your [issues](https://github.com/prod3v3loper/web-spaceship-game/issues).
...
Show all [pulls](https://github.com/prod3v3loper/web-spaceship-game/pulls).